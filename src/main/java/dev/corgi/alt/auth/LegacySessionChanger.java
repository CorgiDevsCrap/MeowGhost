...
public class LegacySessionChanger {

	private static LegacySessionChanger instance;
	private final UserAuthentication auth;

	public static LegacySessionChanger getInstance() {
		if (instance == null) {
			instance = new LegacySessionChanger();
		}
