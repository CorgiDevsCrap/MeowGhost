...
public class GuiConfigManager extends GuiScreen {
    ...
    protected void actionPerformed(final GuiButton button) {
        if (button.id == 0) {
            if(this.username.getText().equals("")) {
                ...
                MeowGhost.instance.saveLoad.fileName = username.getText();
                MeowGhost.instance.saveLoad.load();
            }
        }
        if(button.id == 1) {
            if(this.username.getText().equals("")) {
    ...
    public void drawScreen(final int x2, final int y2, final float z2) {
        ...
        Gui gui = new Gui();
		gui.drawCenteredString(this.mc.fontRendererObj, MeowGhost.instance.saveLoad.fileName, (int)(this.width / 2), (int)(sr.getScaledHeight() / 2 - 65), -1);
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 50 - 10, this.height / 2 - 20, 120, 20, I18n.format("Load Config", new Object[0])));
        this.buttonList.add(new GuiButton(1, this.width / 2 - 50 - 10, this.height / 2 + 10, 120, 20, I18n.format("Save Config", new Object[0])));
