package dev.corgi.clickgui.component;

import java.util.ArrayList;

import dev.corgi.MeowGhost;
import dev.corgi.clickgui.component.components.Button;
...
public class Frame {
	...
	public Frame(Category cat) {
		...
		for(Module mod : MeowGhost.instance.moduleManager.getModulesInCategory(category)) {
