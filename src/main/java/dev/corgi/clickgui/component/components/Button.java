package dev.corgi.clickgui.component.components;
...
import dev.corgi.clickgui.component.Frame;
import dev.corgi.clickgui.component.components.sub.Checkbox;
import dev.corgi.clickgui.component.components.sub.Keybind;
import dev.corgi.clickgui.component.components.sub.ModeButton;
import dev.corgi.clickgui.component.components.sub.Slider;
import dev.corgi.clickgui.component.components.sub.VisibleButton;
...
public class Button extends Component {
	...
	public Button(Module mod, Frame parent, int offset) {
		...
		height = 12;
		int opY = offset + 12;
		if(MeowGhost.instance.settingsManager.getSettingsByMod(mod) != null) {
			for(Setting s : MeowGhost.instance.settingsManager.getSettingsByMod(mod)){
				if(s.isCombo()){
