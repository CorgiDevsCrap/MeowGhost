...
public class MainMenu extends GuiScreen implements MinecraftInstance
{
    ...
    private ArrayList<ButtonMainMenu> buttons = new ArrayList<>();

    public MainMenu()
    {
        buttons.add(new ButtonMainMenu("Singleplayer", 0, 0, 100, 20));
        buttons.add(new ButtonMainMenu("Multiplayer", 0, 0, 100, 20));
        buttons.add(new ButtonMainMenu("AltManager", 0, 0, 100, 20));
        buttons.add(new ButtonMainMenu("Settings", 0, 0, 100, 20));
        buttons.add(new ButtonMainMenu("Quit", 0, 0, 100, 20));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        GlStateManager.translate(-(width / 2f), -(height / 2f), 0);
        drawCenteredString(fontRendererObj, MeowGhost.cn, width / 2, height / 2 - 30, -1);
        GlStateManager.popMatrix();
        int y = 20;
        buttons.get(0).setXY(sr.getScaledWidth() / 2 - ((205) / 4), sr.getScaledHeight() / 2 - 50);
        buttons.get(1).setXY(sr.getScaledWidth() / 2 - ((205) / 4), sr.getScaledHeight() / 2 - 50 + 22);
        buttons.get(2).setXY(sr.getScaledWidth() / 2 - ((205) / 4), sr.getScaledHeight() / 2 - 50 + 44);
        buttons.get(3).setXY(sr.getScaledWidth() / 2 - ((205) / 4), sr.getScaledHeight() / 2 - 50 + 66);
        buttons.get(4).setXY(sr.getScaledWidth() / 2 - ((205) / 4), sr.getScaledHeight() / 2 - 50 + 88);

        for(ButtonMainMenu b : buttons) {
