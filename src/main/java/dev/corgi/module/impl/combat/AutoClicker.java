...
public class AutoClicker extends Module {
	...
	public AutoClicker() {
		...
		MeowGhost.instance.settingsManager.rSetting(new Setting("MinCPS", this, 8, 1, 20, true));
		MeowGhost.instance.settingsManager.rSetting(new Setting("MaxCPS", this, 12, 1, 20, true));
	}
