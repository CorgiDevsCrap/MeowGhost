...
public class NewAimAssist
    ...
    public NewAimAssist() {
        ...
        MeowGhost.instance.settingsManager.rSetting(ignoreFriends = new Setting("IgnoreFriends", this, true));
    }
                        ...
                        do {
                            do {
                                    do {
                                        ...
                                        if(MeowGhost.instance.friendsManager.checkFriend(en.getDisplayNameString())) {
                                            en = null;
                                        }
                                    } while (en == mc.thePlayer);
                            } while (Objects.requireNonNull(en).deathTime != 0);
